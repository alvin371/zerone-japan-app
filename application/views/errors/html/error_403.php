    ...
    <div class="error-container">
        <div class="error-card">
            ...
            <div class="btn-group">
                ...
                <a href="mailto:admin@bkasystem.com?subject=Access Request&body=Hi, I need access to a restricted page. My current role is: <?php echo $_SESSION['user']['role'] ?? 'Unknown'; ?>" class="btn-custom btn-warning">
            ...
            <div class="help-links">
                ...
                <a href="mailto:support@bkasystem.com" class="btn-link">
