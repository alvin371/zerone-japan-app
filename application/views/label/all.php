<div class="w-100">
    <div class="row align-items-center">
        <div class="col-lg-12 mb-3">
            <h3 class="text-primary fw-600">SERVICE</h3>
        </div>
            ...
            <table class="table table-hover table-striped table-bordered" id="datatable">
                <thead>
                    <tr class="bg-primary text-white">
                        ...
                        <th class="text-start">BACKGROUND</th>
                        <th class="text-start">COLOR</th>
                        <th class="text-end">MIN TRX</th>
                        <th class="text-end">MIN NOMINAL</th>
                        <th class="text-end">SERVICE MONTH</th>
                ...
                <tbody>
                    <?php foreach ($data as $k => $v) { ?>
                        <tr>
                            ...
                            <td class="req text-start"><?= $v['background'] ?></td>
                            <td class="req text-start"><?= $v['color'] ?></td>
                            <td class="req text-end"><?= $v['min_trx'] ?></td>
                            <td class="req text-end"><?= $v['min_nominal'] ?></td>
                            <td class="req text-end"><?= $v['service_month'] ?></td>
...
<script>
    function create() {
        ...
        $("#load-form").load("<?= base_url() ?>/label/create");
    }
    ...
    function edit(id) {
        ...
        $("#load-form").load("<?= base_url() ?>/label/edit?id=" + id);
    }
    ...
    function remove(id) {
        ...
        $("#load-form").load("<?= base_url() ?>/label/remove?id=" + id);
    }
</script>